...
export default function OutingsPage() {
  return <PageFrame>
    <PageHero eyebrow="Golf outings" title="A smooth event from the first group out to the final scorecard." body="Rosebud hosts charity tournaments, company outings, customer events, fundraisers, bachelor-party rounds, and community golf days." />

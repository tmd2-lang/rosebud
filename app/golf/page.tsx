...
import { PageFrame, PageHero, Placeholder } from "../site-components";
...
export default function GolfPage() {
  return <PageFrame>
    <PageHero eyebrow="The course" title="Playable, walkable, and never quite the same round twice." body="Rosebud is an 18-hole, par-71 course shaped by mature trees, small greens, uneven lies, and more than fifty years of local golf."><Link className="button button-cream" href="/tee-times">Book a tee time</Link></PageHero>

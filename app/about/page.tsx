...
export default function AboutPage() {
  return <PageFrame>
    <PageHero eyebrow="Our story" title="It started with nine holes and a patch of roses." body="For more than fifty years, Rosebud has given local golfers a welcoming place to play, gather, and feel like they belong." />

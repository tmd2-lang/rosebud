...
export default function ContactPage() {
  return <PageFrame>
    ...
    <section className="section-shell"><SiteImage className="landscape-placeholder contact-image" src="/rosebud-images/clubhouse-patio.png" alt="The Rosebud clubhouse patio overlooking the course" position="center" /></section>

...
export default function MembershipPage() {
  return <PageFrame>
    <PageHero eyebrow="Membership" title="Your home course, without the private-club formality." body="Rosebud membership gives regular golfers better access, better value, and more ways to be part of the course." />
